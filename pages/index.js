...
const About = () => {
  return (
    <div className="flex flex-col md:flex-row gap-20 my-12">
      <div className="w-60 md:w-4/12 rounded-[100%] shadow-2xl m-auto border-2 border-black outline-dashed outline-2 outline-black outline-offset-4 relative">
        <Image
          src="/about_me.png"
          width="100%"
          height="100%"
      ...
      <div className="md:w-8/12 md:text-left">
        ...
        <p className="text-justify">
          ...
          vel magni. Porro cupiditate nam, labore a dicta natus?
        </p>
