...
const About = () => {
  return (
    <div className='flex flex-col md:flex-row gap-12 my-12'>
      <div className='w-5/12 rounded-[100%] shadow-2xl m-auto border-2 border-black outline-dashed outline-2 outline-black outline-offset-4 relative'>
        <Image src='/about_me.png' width={4} height={4} layout='responsive' alt='me'></Image>
      </div>
      <div className='md:w-7/12 xl:text-left'>
        ...
        <p className='font-display font-bold text-2xl mt-12 text-right'>Jó böngészést!</p>
      </div>
    </div>
  );
};
